...
<div class="main">
    ...
    <div class="container">
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="table-responsive bg-white" data-mdb-perfect-scrollbar="true" style="position: relative; height: 780px">
        ...
        $i=1;
        $sql = "SELECT * FROM userform"; //panggil table pelajar
            ...
            while($row = $query->fetch_assoc()){
              $id=$row['id'];
                ...
                "<tr>
                    ...
                    <td>".$row['sebab']. "</td>
                    <td>
                    <a href='admin_view.php?view={$id}' class='btn btn-warning'> <i class='bi bi-eye'></i></a>
                   <a href='admin_edit.php?update&&edit={$id}' class='btn btn-success'><i class='bi bi-pencil-square'></i></a>
                  <a href='admin_delete.php?delete={$id}' class='btn btn-danger'><i class='bi bi-trash'></i></a>
                    </td>
      ...
      <div>
        &nbsp;<a href="admin_home.php" class="back">Back</a>
      </div>
      <div class="footer">
